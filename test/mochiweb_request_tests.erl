...
accepts_content_type_test() ->
    Req1 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req2 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
                                mochiweb_headers:make([{"Accept", "text/html"}])),
    ?assertEqual(false, mochiweb_request:accepts_content_type("multipart/related", Req2)),

    Req3 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req4 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req5 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req6 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req7 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req8 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req9 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req10 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req11 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req12 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
    ...
    Req13 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
                                 mochiweb_headers:make([{"Accept", "text/html; level=1; q=0.0, text/html"}])),
    ?assertEqual(false, mochiweb_request:accepts_content_type("text/html; level=1", Req13)),

    Req14 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
...
accepted_encodings_test() ->
    ...
    ?assertEqual([], mochiweb_request:accepted_encodings(["gzip", "identity"], Req8)).
...
accepted_content_types_test() ->
    ...
    Req7 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
                                mochiweb_headers:make([{"Accept", "text/html;q=0.5, application/json;q=0.5"}])),
    ?assertEqual(["application/json", "text/html"],
                 mochiweb_request:accepted_content_types(["application/json", "text/html"], Req7)),

    Req8 = mochiweb_request:new(?Transport, sock, 'GET', "/foo", {1, 1},
                                mochiweb_headers:make([{"Accept", "text/html"}])),
    ?assertEqual([], mochiweb_request:accepted_content_types(["application/json"], Req8)),
...
should_close_test() ->
    F = fun (V, H) ->
                ...
                mochiweb_request:should_close(Req)
        end,
    ?assertEqual(
       true,
